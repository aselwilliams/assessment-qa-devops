...
const drawFive = () => {
    axios.get('http://3.15.190.184/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://3.15.190.184/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://3.15.190.184/api/player')
...
const getAllBots = () => {
    axios.get('http://3.15.190.184/api/robots')
        .then(({data}) => {
